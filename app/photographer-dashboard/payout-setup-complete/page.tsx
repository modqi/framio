...
export default function PayoutSetupComplete() {
  const t = useTranslations("PayoutSetupComplete");
      ...
      <div style={{flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "48px 32px"}}>
        <div style={{maxWidth: "520px", width: "100%", textAlign: "center"}}>
          ...
          <div style={{backgroundColor: "#FDFBF8", borderRadius: "12px", padding: "24px", border: "1px solid #E2D5C8", marginBottom: "32px", textAlign: "left"}}>
            <p style={{fontSize: "11px", color: "#C8622A", margin: "0 0 16px", letterSpacing: "0.15em", fontFamily: "'Jost', sans-serif", fontWeight: "500"}}>{t("whatHappensNow")}</p>
            {steps.map((step, i) => (
              <div key={i} style={{display: "flex", gap: "12px", alignItems: "flex-start", marginBottom: i < steps.length - 1 ? "12px" : "0"}}>
