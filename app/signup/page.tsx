      ...
      <div className="flex flex-col justify-center flex-1" style={{padding: "48px 32px", maxWidth: "600px", margin: "0 auto", overflowY: "auto"}}>
        ...
        <div style={{display: "flex", gap: "8px", marginBottom: "32px", backgroundColor: "#F0EAE0", padding: "4px", borderRadius: "999px"}}>
          <button
            ...
            style={{flex: 1, padding: "10px", border: "none", borderRadius: "999px", fontSize: "13px", cursor: "pointer", backgroundColor: role === "client" ? "#C8622A" : "transparent", color: role === "client" ? "#FDFBF8" : "#1A0E06", fontWeight: "500", fontFamily: "'Jost', sans-serif"}}
          >
            {t("form.roleBook")}
          </button>
          <button
            onClick={() => { setRole("photographer"); setError(""); }}
            style={{flex: 1, padding: "10px", border: "none", borderRadius: "999px", fontSize: "13px", cursor: "pointer", backgroundColor: role === "photographer" ? "#C8622A" : "transparent", color: role === "photographer" ? "#FDFBF8" : "#1A0E06", fontWeight: "500", fontFamily: "'Jost', sans-serif"}}
          >
