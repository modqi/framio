          ...
          <div className="flex gap-3 mb-6">
            <button
              ...
              style={{
                ...
                padding: "10px",
                borderRadius: "8px",
                border: role === "client" ? "2px solid #1a1a1a" : "1px solid #e5e5e5",
                backgroundColor: role === "client" ? "#1a1a1a" : "white",
                color: role === "client" ? "white" : "#888",
                fontSize: "14px",
                fontWeight: "500",
                cursor: "pointer"
              }}
            ...
            <button
              ...
              style={{
                ...
                padding: "10px",
                borderRadius: "8px",
                border: role === "photographer" ? "2px solid #1a1a1a" : "1px solid #e5e5e5",
                backgroundColor: role === "photographer" ? "#1a1a1a" : "white",
                color: role === "photographer" ? "white" : "#888",
                fontSize: "14px",
                fontWeight: "500",
                cursor: "pointer"
              }}
