...
export default function AuthModal({ open, onClose }: AuthModalProps) {
  ...
  const googleBtn = (
    <button type="button" onClick={handleGoogle} style={{width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", border: "1px solid #E2D5C8", borderRadius: "999px", padding: "12px 20px", backgroundColor: "#fff", cursor: "pointer", fontFamily: "'Jost', sans-serif", fontSize: "14px", fontWeight: "500", color: "#1A0E06", marginBottom: "6px"}}>
      ...
      <div style={card} className="auth-modal-card">
        ...
        {step === "email" && (
          <>
            {heading(t("heading"))}
            {googleBtn}
            <p style={{fontSize: "11px", color: "#7A5C44", textAlign: "center", fontFamily: "'Jost', sans-serif", margin: "0 0 20px", lineHeight: "1.5"}}>{t("googleDataNote")}</p>
            {divider}
