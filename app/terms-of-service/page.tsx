...
const sectionDefs: SectionDef[] = [
  { key: "s1",  type: "body"             },
  { key: "s2",  type: "body"             },
  { key: "s3",  type: "list", items: 3  },
  { key: "s4",  type: "list", items: 3  },
  { key: "s5",  type: "list", items: 3  },
  { key: "s6",  type: "body"             },
  { key: "s7",  type: "list", items: 3  },
  { key: "s8",  type: "body"             },
  { key: "s9",  type: "body"             },
  { key: "s10", type: "body"             },
  { key: "s11", type: "contact"          },
];
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 32px 64px" }}>
        {sectionDefs.map((def, i) => {
          ...
          if (def.type === "body") {
            ...
            content = (
              <>
                <p style={{ ...bodyStyle, marginBottom: "16px" }}>{t("sections.s11.body")}</p>
                <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                  <p style={bodyStyle}>
                    <span style={labelStyle}>{t("sections.s11.emailLabel")}:</span>{" "}
                    <a href="mailto:hello@lomissa.com" style={{ color: "#C8622A", textDecoration: "none" }}>
                      hello@lomissa.com
                    </a>
                  </p>
                  <p style={bodyStyle}>
                    <span style={labelStyle}>{t("sections.s11.addressLabel")}:</span>{" "}
                    {t("sections.s11.address")}
                  </p>
                </div>
              </>
            );
