  ...
  return (
    <main className="min-h-screen" style={{backgroundColor: "#FDFBF8"}}>
      ...
      <nav style={{borderBottom: "1px solid #E2D5C8", backgroundColor: "rgba(253,251,248,0.96)", backdropFilter: "blur(12px)"}} className="flex items-center justify-between px-8 py-4">
        <Logo size="sm" />
        <div className="flex items-center gap-3"><GlobeModal /><a href="/login" style={{fontSize: "13px", color: "#7A5C44", textDecoration: "none", fontFamily: "'Jost', sans-serif"}}>{t("nav.backToLogin")}</a></div>
      </nav>
      ...
      <div style={{maxWidth: "480px", margin: "80px auto", padding: "0 32px"}}>
        {sent ? (
          <div style={{backgroundColor: "#FDFBF8", borderRadius: "12px", padding: "48px 32px", border: "1px solid #E2D5C8", textAlign: "center"}}>
            ...
            <p style={{fontSize: "11px", color: "#C8622A", margin: "0 0 12px", letterSpacing: "0.15em", fontFamily: "'Jost', sans-serif", fontWeight: "500"}}>{t("sent.badge")}</p>
            ...
            <p style={{fontSize: "14px", color: "#7A5C44", margin: "0 0 32px", lineHeight: "1.7", fontFamily: "'Jost', sans-serif", fontWeight: "300"}}>
              {t("sent.description", { email } as any)}
            </p>
          ...
          <div style={{backgroundColor: "#FDFBF8", borderRadius: "12px", padding: "48px 32px", border: "1px solid #E2D5C8"}}>
            <p style={{fontSize: "11px", color: "#C8622A", margin: "0 0 12px", letterSpacing: "0.2em", fontFamily: "'Jost', sans-serif", fontWeight: "500"}}>{t("form.badge")}</p>
            ...
            <div style={{marginBottom: "24px"}}>
              <label style={{fontSize: "11px", color: "#7A5C44", display: "block", marginBottom: "8px", letterSpacing: "0.05em", fontFamily: "'Jost', sans-serif"}}>{t("form.emailLabel")}</label>
              <input
                type="email"
                value={email}
            ...
            <p style={{fontSize: "13px", color: "#7A5C44", textAlign: "center", margin: "0", fontFamily: "'Jost', sans-serif"}}>
              ...
              <a href="/login" style={{color: "#C8622A", textDecoration: "none"}}>{t("form.logIn")}</a>
            </p>
          </div>
        )}
      </div>
