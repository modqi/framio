...
// Flag emoji from ISO code (works for all valid 2-letter codes)
...
export const DEFAULT_COUNTRY = COUNTRIES.find(c => c.code === "NO")!;

// Set of all valid dial codes for server-side validation
export const VALID_DIAL_CODES = new Set(COUNTRIES.map(c => c.dial));
